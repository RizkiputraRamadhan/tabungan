            ...
            <div class="auth-box bg-dark  border-secondary">
                <div id="loginform">
                    ...
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img width="90%" src="{{ asset('storage/logo_sipenting.png') }}" alt="logo" /></span>
                    </div>
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                                    @error('email')
