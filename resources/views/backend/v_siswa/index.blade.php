                    ...
                    <form id="createQuestionForm"  style="display: none;" action="siswa/store" method="post" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan Nama Siswa">
                                @error('name')
                            ...
                            <div class="form-group">
                                <label>No Induk Siswa <span class="font-10 text-danger">*</span></label>
                                <input type="text" name="no_induk" value="{{ old('no_induk') }}" class="form-control @error('no_induk') is-invalid @enderror" placeholder="Masukkan Nama Siswa">
                                @error('no_induk')
                                <span class="invalid-feedback alert-danger" role="alert">
                                    {{ $message }}
                                </span>
                            ...
                            <div class="form-group" style="display: none;" >
                                <label>Status</label>
                                <input type="text" name="typeuser"  value="3" class="form-control @error('typeuser') is-invalid @enderror" placeholder="Masukkan typeuser">
                                @error('typeuser')
                                <span class="invalid-feedback alert-danger" role="alert">
                                    {{ $message }}
                                </span>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{$row->email}} </td>
                                <td align="center">
                                    <a class="m-1" href="{{ url('siswa/edit', $row->id) }}" title="Ubah Data">
                                        <span class="btn btn-cyan btn-sm text-white"><i class="fa fa-edit"></i>Ubah</span>
                                    </a>
                                    <a href="{{ url('siswa/profile', $row->id) }}" title="Lengkapi Data">
                                        <span class="btn btn-info btn-sm text-white"><i class="fa fa-user"></i> Lengkapi</span>
                                    </a>
                                    <a class="m-1" href="{{ url('siswa/detail', $row->id) }}" title="Detail Data">
                                        <span class="btn btn-success btn-sm text-white"><i class="fa fa-edit"></i>Detail</span>
                                    </a>
                                    <form class="m-1" method="POST" action="{{ url('siswa/destroy', $row->id) }}" style="display: inline-block;">
                                        @method('delete')
                                        @csrf
